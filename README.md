...
<ol>
<li><strong>Model Params</strong>
<ol>
<li><strong>Scale</strong>: use this to set your export scale. If for instance your model was exported from Object Builder with "Master Scale" set to 10, then use 10. Default is 10.</li>
<li><strong>Source</strong>: animation source which will be stored in macros. You can use of the <strong>existing animation sources</strong> or type some custom one if you are working with objects/vehicles.</li>
<li><strong>Model</strong> <strong>center</strong>: picker for center of the model - <strong>this is very important when working with reload animations</strong> since if this is not defined, then script will assume that center is located at [0,0,0] coordinates (<em>which is fine for i.e. objects</em>) and produce fault result. Right click on that button resets it default value (0,0,0 coords)</li>
<li><strong>Parent Object</strong>: Use if you have multi bone setup like magazine being part of barrel which is folded during reload.</li>
<li><strong>Child Object</strong>: Use that button to pick object which you want to export transformations from.</li>
</ol></li>
<li><strong>Save params</strong>
<ol>
<li><strong>Add animations macros</strong>: animation macros contains, as name suggest, macros for all animations. In case you would like to use some custom values (like range being from 0 to 100 instead of default 0-1) then feel free to do so. By default it's on and I recommend to leave it this way</li>
<li><strong>Save path</strong>: path to file were your output will be stored. You can either paste path manually there or use "<strong>Pick save path</strong>" button to do so.</li>
<li><strong>Pick save path</strong>: button for selecting output file</li>
<li><strong>Start Exporting</strong>: fun!</li>
</ol></li>
</ol>
<p><br />
</p></th>
